(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                new core(".slider-quotes", {
                    ...
                    navigation: {
                        nextEl: ".slider-quotes-control__circle"
                    },
                    on: {}
                });
            }
        ...
        da.init();
        let profile_icon = document.querySelector(".profile-header__icon");
        profile_icon.addEventListener("click", (function(e) {
            const profile_menu = document.querySelector(".profile-header__menu");
            profile_menu.classList.toggle("_active");
        }));
        document.addEventListener("click", (function(e) {
            if (!e.target.closest(".profile-header")) {
                const profile_menu = document.querySelector(".profile-header__menu");
                profile_menu.classList.remove("_active");
            }
        }));
        window["FLS"] = true;
        isWebp();
